...
public class RubotoTests extends org.ruboto.RubotoActivity {
    ...
    private void initJRuby(final boolean firstTime) {
        new Thread(new Runnable() {
            public void run() {
                final boolean jrubyOk = Script.setUpJRuby(RubotoTests.this);
                if (jrubyOk) {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            if (firstTime) {
                                ...
                                Toast.makeText(RubotoTests.this,"Failed to initialize Ruboto Core.",Toast.LENGTH_SHORT).show();
                                try {
